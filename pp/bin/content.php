...
<body class="fixed-sn  mdb-skin-custom" data-spy="scroll" data-target="#scrollspy" data-offset="15">
  ...
  <script type='text/javascript'>
    ! function(e, n, t) {
      ...
      e.getElementById(t) || ((o = e.createElement(n)).id = t, o.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.0", c.parentNode.insertBefore(o, c))
  ...
  <script src='js/compiled.gzip.js'></script>
  <script src='js/compiled.min.js'></script>
  <script src='js/compiled.footer.js'></script>
  <script src='js/jquery.validate.js'></script>
  <!--RSS as Nav and Grid-->
  <script src='js/compiled.rss.js?hash=AE1x'></script>
  <script src="https://cdn.jsdelivr.net/npm/sweetalert"></script>
  <script src="js/adsense.js?hash=AE1x"></script>
  <script src="WMI/safelink/safelink.js?hash=AE1x"></script>
